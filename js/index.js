...
function uncompressPixelValues (data, TypedArrayClass, maskBitset, noDataValue, storeDecodedMask) {
  var blockIdx = 0;
...
function computeUsedBitDepths (data) {
...
function parse (input, fp, skipMask) {
  var data = {};
...
function unstuff (src, bitsPerPixel, numPixels, offset, scale, dest, maxValue) {
...
var defaultNoDataValue = -3.4027999387901484e+38; // smallest Float32 value
...
export function decode (input, options) {
  ...
  */
  ...
  var noDataValue = (options.noDataValue != null) ? options.noDataValue : defaultNoDataValue;
